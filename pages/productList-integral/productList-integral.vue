	...
	<view>
		...
		<view class="">
			<view class="productList d-flex j-sb flex-wrap mx-3">
				<view class="item rounded10 mt-3 pr" v-for="(item,index) in productData" :key="index" @click="Router.navigateTo({route:{path:'/pages/integralDetail/integralDetail'}})">
					...
					<view class="infor">
						...
						<view class="priceF font-32 font-weight mt-2">56</view>
					</view>
				</view>
			</view>
